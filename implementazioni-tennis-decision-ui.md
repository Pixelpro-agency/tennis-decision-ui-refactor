...
- evitare che note operative, artifact di una singola run o cronologie di lavorazione diventino documentazione permanente.
...
- [Implementazioni proposte](./implementazioni/06-implementazioni-proposte.md) — indice di 6 moduli.
...
I materiali non canonici preservati restano separati dalla documentazione tecnica corrente, non costituiscono prova del comportamento attuale e non vengono eliminati mediante cleanup generici o automatici.
...
→ documenti canonici in Markdown ordinario
→ descrivono soltanto comportamento reale e verificato
→ ogni documento resta verificabile contro il codice corrente

Modularizzazione
→ audit documentazione: 4 moduli
→ audit codice: 7 moduli
→ implementazioni proposte: 6 moduli
...
Le decisioni documentali correnti includono `DEC-025` e `DEC-027`.
...
- un controllo strutturale superato non prova da solo l’allineamento semantico di ogni documento;
