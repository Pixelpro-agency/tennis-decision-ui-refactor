...
- [07-workflow-esecutivo.md](./07-workflow-esecutivo.md) — task, ruoli, revisione, consegna e chiusura;
- [08-linee-guida-chat-e-ai.md](./08-linee-guida-chat-e-ai.md) — selezione contesto e istruzioni per Chat Analisi, Chat Esecutore e Desktop;
