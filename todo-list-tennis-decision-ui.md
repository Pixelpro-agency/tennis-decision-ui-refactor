...
8. [Workflow operativo e preparazione task esecutive — Blocco I](./todo-list-tennis-decision-ui/10-preparazione-task-esecutive.md)
9. [Stato di chiusura — Blocco J](./todo-list-tennis-decision-ui/11-stato-di-chiusura.md)
...
| Preparare o verificare workflow operativo e task esecutive         | [10 — Workflow operativo e preparazione task](./todo-list-tennis-decision-ui/10-preparazione-task-esecutive.md) |
| Verificare struttura, modularizzazione o cleanup documentale       | [Metodo, stati e regole](./implementazioni/00-metodo-e-stati.md)                                          |
...
- [10 — Workflow operativo e preparazione task](./todo-list-tennis-decision-ui/10-preparazione-task-esecutive.md);
