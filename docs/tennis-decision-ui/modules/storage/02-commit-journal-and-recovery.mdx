export const meta = {
id: 'commit-journal-and-recovery',
order: 2,
title: 'Commit journal e recovery',
};
...
Il comportamento è coperto da test mirati e validazione locale integrata. Restano da validare sessioni live/replay reali, riavvii reali del processo e failure operative su filesystem non simulato.
...
* [Timeline e history](./01-timelines-and-history.mdx)
