...
→ 404 = evidence null senza errore
→ 404 con integrity preserva integrity
→ 200 con persistenceComplete:false inoltra dataQuality
→ 200 con sources.sofa / sources.betfair inoltra sources
