export const meta = {
id: 'local-context-and-point-by-point',
order: 2,
title: 'Contesto locale e point-by-point',
};
...
* [Tracking live](./01-live-tracking.mdx)
* [Timeline e history](../storage/01-timelines-and-history.mdx)
* [API Match](../../api/01-match.mdx)
* [Scraper SofaScore](../python/02-sofascore-scraper.mdx)
