...
processor/persistenceCommit.test.mjs
...
processor/persistenceRecovery.test.mjs
→ repair pending senza nuovo tick

processor/runtimeOrchestration.test.mjs
→ sample tecnico senza mutazione marketState

trackerUpdate/technicalRecovery.test.mjs
